...
class DB:
    ...
    def _connection(self, *, environment: dict, name: str) -> create_engine:
        ...
        match db_name:
            case 'postgresql':
                environment[name]['USER'] = getenv("DB_POSTGRESQL_USER")
                environment[name]['PASSWORD'] = getenv("DB_POSTGRESQL_PASSWORD")
            ...
            case 'oracle':
                environment[name]['USER'] = getenv("DB_ORACLE_USER")
                environment[name]['PASSWORD'] = getenv("DB_ORACLE_PASSWORD")
                engine = create_engine(
